            ...
            <div class="row flex-center h-100 g-0 px-4 px-sm-0">
              <div class="col col-sm-6 col-lg-7 col-xl-8 mb-4">
                ...
                <div class="text-center">
                  <h3 class="text-body-highlight">Vous êtes déconnecté</h3>
                </div>
                <div class="d-grid"><a class="btn btn-primary mt-5" href="{{ route('login') }}"><span class="fas fa-angle-left me-2"></span>Retour à la page de connexion</a></div>
              </div>
            </div>
          </div>
        </div>
