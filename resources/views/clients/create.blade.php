			...
			<div class="content">
				<nav class="mb-3" aria-label="breadcrumb">
					<ol class="breadcrumb mb-0">
						...
						<li class="breadcrumb-item">Enregistrer un nouveau client</li>
					</ol>
				</nav>
						...
						<form class="row g-3" action="{{ route('clients.store') }}" method="POST" >
							...
							<div class="col-sm-6 col-md-3">
								<div class="form-floating">
									...
									<label for="floatingSelectOwner">Type du client</label>
								</div>
							</div>
							...
							<div class="col-sm-6 col-md-3">
								<div class="form-floating">
									...
									<label for="floatingSelectCity">Origine du dossier</label>
								</div>
							</div>
							<div class="col-sm-6 col-md-3">
								<div class="form-floating">
									...
									<label for="floatingSelectCity">Nature du projet</label>
								</div>
							</div>
							<div class="col-sm-6 col-md-3">
								<div class="form-floating">
									<select class="form-select" name="prospecteur">
										<option disabled selected></option>
										<option value="agadir">Agadir</option>
										<option value="casablanca">Casablanca</option>
									</select>
									<label for="floatingSelectCity">Prospecteur</label>
								</div>
							</div>
							<div class="col-sm-6 col-md-3" >
								<div class="form-floating">
